<template>
  <div class="edit-page-v3">
    ...
    <div v-else class="edit-form-v3">
      ...
      <div class="edit-field">
        <label>性别</label>
        <!-- select replaced: use picker --><input class="form-input" placeholder="请选择" :value="form.gender" />
      </div>
      ...
      <div class="edit-field">
        <label>隐身模式</label>
        <!-- select replaced: use picker --><input class="form-input" placeholder="请选择" :value="form.ghost_mode" />
      </div>

      <div class="edit-field">
        <label>允许私信</label>
        <!-- select replaced: use picker --><input class="form-input" placeholder="请选择" :value="form.allow_private_msg" />
      </div>

      <div class="edit-field">
        <label>允许查看资料</label>
        <!-- select replaced: use picker --><input class="form-input" placeholder="请选择" :value="form.allow_profile_view" />
      </div>
