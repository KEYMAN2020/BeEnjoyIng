...
import config
AMAP_KEY = config.active_config.AMAP_KEY
AMAP_POI_SEARCH_URL = config.active_config.AMAP_POI_SEARCH_URL
AMAP_GEOCODE_URL = config.active_config.AMAP_GEOCODE_URL
