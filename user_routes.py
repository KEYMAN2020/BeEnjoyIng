...
def upload_avatar():
    ...
    if file and file.filename:
        ...
        if ext not in ("png", "jpg", "jpeg", "gif", "webp"):
            return error("仅支持 png/jpg/jpeg/gif/webp 格式", 400)
    ...
    achievements = [
        {
            ...
            "name": "初出茅庐",
            "desc": "报名第1个活动",
            "current": min(total_signups, 1),
            "target": 1,
            "done": total_signups >= 1,
        },
        {
            "key": "five_joins",
            "name": "活跃分子",
            "desc": "报名5个活动",
            "current": min(total_signups, 5),
            "target": 5,
            "done": total_signups >= 5,
        },
        {
            "key": "ten_joins",
            "name": "社交达人",
            "desc": "报名10个活动",
            "current": min(total_signups, 10),
            "target": 10,
            "done": total_signups >= 10,
        },
        {
            "key": "week_warrior",
            "name": "周游达人",
            "desc": "一周内参加3场",
            "current": min(week_signups, 3),
            "target": 3,
            "done": week_signups >= 3,
        },
        {
        ...
        },
        {
            ...
            "name": "发起者",
            "desc": "创建第1个活动",
            "current": 1 if has_created else 0,
            "target": 1,
            "done": has_created,
        },
    ]
